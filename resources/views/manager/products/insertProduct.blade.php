                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-blue-600 md:ml-2">Add New</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-3xl font-bold text-gray-900">Add New Product</h1>
                    <p class="mt-2 text-sm text-gray-600">Fill in the product details below to add it to your inventory</p>
                </div>
                <div>
                    <a href="{{ route('product.index') }}"
                ...
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    ...
                                    <select id="category" name="category"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('category') == $category->id) selected @endif>{{ $category->cat_title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <!-- Sell Price -->
                            <div class="sm:col-span-2">
                                <label for="sell_price" class="block text-sm font-medium text-gray-700">Sell Price
                                    *</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 sm:text-sm">$</span>
                                    ...
                                    <input type="number" name="sell_price" id="sell_price"
                                        value="{{ old('sell_price') }}" step="0.01" min="0"
                                        class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md py-2 px-3 border"
                                        placeholder="0.00">
                            ...
                            <!-- Warranty -->
                            <div class="sm:col-span-3">
                                <label for="warranty" class="block text-sm font-medium text-gray-700">Warranty Period
                                    *</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <!-- Barcode -->
                            <div class="sm:col-span-3">
                                <label for="barcode" class="block text-sm font-medium text-gray-700">Barcode
                                    (Optional)</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
