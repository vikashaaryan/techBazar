                ...
                <form action="" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Product Information</h2>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="unit" 
                                    class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" required>
                        ...
                        <div class="md:col-span-2 mt-4">
                            <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Pricing & Inventory</h2>
                        </div>
                        ...
                        <div class="md:col-span-2 mt-4">
                            <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Additional Information</h2>
                        </div>
                    ...
                    <div class="mt-8 flex justify-end space-x-4">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition">
                            Add Product
                        </button>
                    </div>
                </form>
